# ROS2 installation for Ubuntu 18.04
The jetson nano is running ubuntu 18.04 "Bionic Beaver", so it is best to practice ROS2 in the same version to avoid uncapability errors when creating scripts.

## Download Ubuntu and Virtual Box
Download [ubuntu 18.04 desktop image](https://releases.ubuntu.com/18.04/) and [Virtual box](https://www.virtualbox.org/) to run Ubuntu 18.04
